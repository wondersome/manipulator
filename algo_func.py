    ...
    for col in range(a, b):
        ...
        if value1[1][big] == '':  # Проверяем есть ли сверху маленький кубик
            ...
            for i in range(5):
                if i != big:
                    if third == '':
                        if value1[0][i] != '' and value1[2][i] == '' and value1[1][i] != second:
                            tmp = i
                            indexes.append(tmp)
                    elif value1[0][i]=="" and value1[0][i]!=second:
                            tmp = i
                            indexes.append(tmp)
                    else:
                        if value1[0][i] != '' and value1[2][i] == '' and value1[0][i] != second:
                            tmp = i
                            indexes.append(tmp)
            tmp=5
                ...
                if i != mid:
                    if third == '':
                        if value1[0][i] != '' and value1[2][i] == '' and value1[1][i] != third:
                            tmp = i
                            indexes.append(tmp)
                    elif value1[0][i]=="" and value1[0][i]!=third:
                            tmp = i
                            indexes.append(tmp)
                    else:
