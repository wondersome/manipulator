...
def degrees(m, n, f, k):
    ...
    if k == 6:
        if 270 > m >= 90:
            return round(238.5266 - m,4),round( -n + 71.2861,4),round( -f - 37.3127,4)
        else:
            if 0 <= m < 90:
                return round(-58.5266 - m,4),round( -n - 71.2861,4),round( -f + 37.3127,4)
            else:
                return round(291.4734 - m,4),round( -n - 71.2861,4),round( -f + 37.3127,4)
    ...
    if k == 7:
        if 243.4349 > m >= 63.4349:
            ...
            if 0 <= m < 63.4349:
                return round(-96.3379 - m,4),round( -n - 49.3163,4),round( -f + 51.1541,4)
            else:
                return round(269.6621 - m,4),round( -n - 49.3163,4),round( -f + 51.1541,4)
